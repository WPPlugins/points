...
class Points_Admin {
				...
				<div class="wrap" style="border: 1px solid #ccc; padding:10px;">
					...
					<div class="points-admin-line">
						<div class="points-admin-label">
							<?php echo __( 'Points label', 'points' ); ?>
						</div>
	...
	public static function points_admin_points_edit( $point_id = null ) {
		...
		$output .= sprintf( '<input class="button" type="submit" name="save" value="%s"/>', __( 'Save', 'points' ) );
		$output .= ' ';
		$output .= sprintf( '<a class="cancel" href="%s">%s</a>', $cancel_url, $saved ? __( 'Back', 'points' ) : __( 'Cancel', 'points' ) );
